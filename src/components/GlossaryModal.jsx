...
const TERMS = [
  ...
  { t: 'camp (진영)', d: '5개 표준화 방법이 실제로는 두 진영으로 갈린다: 값의 간격을 보존하는 간격보존형(Min-Max·Min-Max ±α·거리기반·로지스틱)과 등수만 보는 순위전용형(백분위순위).' },
  { t: 'SSI_camp (최종 민감도)', d: '두 진영 대표값의 순위 차이. SSI_camp = |순위(Min-Max) − 순위(백분위순위)|. 방법을 나열 비교하는 대신, 대립하는 두 진영의 차이로 간결하게 재정의한 최종 지표.' },
